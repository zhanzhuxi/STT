...
_DATASET_HYPER_PARAMS = {
    "SumMe":{
        ...
        "ratio": 16,    # controlling hard-negative samples
    },
...
def build_args():
    ...
    parser.add_argument('--num_workers', '-j', type=int, default=0)     # 初始为4
    ...
    parser.add_argument('--lambda_inter_sample_contrastive_loss', type=float, default=0.0)
    parser.add_argument('--ratio', type=int, default=16)

    # 数据集划分
    parser.add_argument('--splits', type=str, default='splits.yml')
